        ...
        <div>
            ...
            {!editing ?
                ...
                <Container>
                    ...
                    <Formik initialValues={{ oldPass: '', password: '', confirmPass: '' }} onSubmit={data => changePass(data)}>
                        <Form>
                            <FormGroup>
                            ...
                            <FormGroup>
                                ...
                                <Field name='passwordConfirm' type='password' placeholder='New Password Confirm' as={Input} />
                            </FormGroup>
                        </Form>
                    </Formik>
                </Container>
